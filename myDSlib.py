...
# Define a function for the imputation process
def impute_missing_values(df):
    """
    Imputes missing values in a dataset using KNN for low/moderate missingness and Iterative Imputer for high missingness.
    ...
    columns_knn = ['MORTDUE', 'VALUE', 'REASON', 'JOB', 'CLAGE', 'CLNO']
    columns_iterative = ['DEBTINC', 'DEROG', 'DELINQ', 'YOJ', 'NINQ']
...
output_file = '/mnt/data/hmeq_imputed.csv'
imputed_df.to_csv(output_file, index=False)

tools.display_dataframe_to_user(name="Imputed Dataset with Function Implementation", dataframe=imputed_df)
